 ...
 * Last Modified: Thursday, October 09 2014, 09:53
 *                                                                             \
...
public class RBTree<T extends Comparable<T>>
{
   ...
   /**
    * Public method to call the recursice put method to insert data into the
    * tree
   ...
   private RBNode<T> put( RBNode<T> node, T data ) throws Exception
   {
      ...
      if( isRed( node.getLeftChild() )       //Red-red conflict with left-outside grandchild
      ...
      if( isRed( node.getRightChild() )      //Red-red conflict with right-outside grandchild
      ...
      if( isRed( node.getLeftChild() )       //Red-red conflict with left-right inside grandchild
      ...
      if( isRed( node.getRightChild() )      //Red-red conflict with right-left inside grandchild
